...
export function DashboardClient({
  ...
  // Re-fetch only when filter/sort/search criteria changes
  useEffect(() => {
    if (
      statusFilter !== "all" ||
      typeFilter !== "all" ||
  ...
  }, [fetchDebts, statusFilter, typeFilter, searchQuery, sortOption]);
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      if (res.ok) {
        toast.success(
          `Catatan transaksi dengan ${deletingDebt.counterpartName} berhasil dihapus`,
          {
